...
namespace OtterTutorial.Entities
{
    public class Player : Entity
    {
        ...
        public Player(float x = 0, float y = 0)
        {
            ...
            sprite.Add("standLeft", new int[] { 4 }, new int[] { 10, 10 });
            sprite.Add("standRight", new int[] { 8 }, new int[] { 10, 10 });
            sprite.Add("standDown", new int[] { 0 }, new int[] { 10, 10 });
            sprite.Add("standUp", new int[] { 12 }, new int[] { 10, 10 });
            sprite.Add("walkRight", new int[] { 8,9,10,11 }, new int[] { 10, 10 });
            sprite.Add("walkLeft", new int[] { 4,5,6, 7 }, new int[] { 10, 10 });
            sprite.Add("walkDown", new int[] { 0,1,2, 3 }, new int[] { 10, 10 });
            sprite.Add("walkUp", new int[] { 12,13,14, 15 }, new int[] { 10, 10 });
        ...
        public override void Update()
        {
            ...
            if (Global.PlayerSession.Controller.B.Pressed)
            {
                sprite.Play("standRight");
                Global.TUTORIAL.Scene.Add(new Bullet(X, Y,Global.DIR_RIGHT));
            }
            if (Global.PlayerSession.Controller.A.Pressed)
            {
                sprite.Play("standDown");
