...
namespace Otter {
    ...
    public static class Extensions {
        ...
        public static void Append(this VertexArray vertices, float x, float y, Color color) {
        ...
        public static void Append(this VertexArray vertices, Vert v) {
            vertices.Append(v.X, v.Y, v.Color, v.TextureX, v.TextureY);
        }
