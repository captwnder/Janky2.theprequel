...
#region Public Properties
        ...
        /// <summary>
        /// The password to use when attempting to access assets in an encrypted zip file.
        /// </summary>
        public string ZipPassword = "otter";

        /// <summary>
        /// The default zip file to search for assets for when using zip file loading.
        /// </summary>
        public string ZipAssets = "Assets/assets.zip";

        /// <summary>
        /// Determines if Otter will search the specified zip folder for assets when loading.
        /// </summary>
        public bool UseZipResources = false;
        ...
        /// </summary>
        public bool LockMouseCenter = false;
...
#region Private Properties
        ...
        internal RenderStates renderStates = RenderStates.Default;
        ...
        public void SetIcon(string source) {
            ...
            if (!File.Exists(source)) {
                var bytes = Util.GetZipFile(ZipAssets, source);
                img = new SFML.Graphics.Image(bytes);
            }
            else {
        ...
        void Update() {
            ...
            Glide.Tweener.Update(DeltaTime);
