...
namespace Otter {
    ...
    public class Controller : Component {
        ...
        /// <summary>
        /// Creates a controller assuming it's an NES pad on a converter to USB on Windows.
        /// </summary>
        /// <param name="joystickId">The id of the joystick</param>
        /// <returns></returns>
        public static Controller GetNESController(int joystickId = 0) {
            var Controller = new Controller(joystickId);

            return Controller;
        }

        public static Controller GetDDRPad(int joystickId = 0) {
            var Controller = new Controller(joystickId);
